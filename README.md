...
id Software LinuxDOOM 1.10
          ...
          ├── i_sound.c   → browser SFX + music backend maintained here
...
Emscripten is still used as the C/C++ → WebAssembly toolchain, and SDL2/SDL2_mixer provide the low-level browser graphics/audio bridge. The DOOM-facing platform implementation is ours.
...
- parses DOOM MUS music data
- converts MUS events to Standard MIDI in our backend
- sends the resulting audio through SDL2_mixer / the browser audio stack
...
- [`direct-port/i_sound_web.c`](https://github.com/pavy23/web-doom/blob/direct-linuxdoom/direct-port/i_sound_web.c) — SFX, MUS/MIDI and audio backend
...
- [`direct-port/shell.html`](https://github.com/pavy23/web-doom/blob/direct-linuxdoom/direct-port/shell.html) — custom DOOM browser UI
...
- Audio bridge: [SDL2_mixer](https://github.com/libsdl-org/SDL_mixer/tree/SDL2)
